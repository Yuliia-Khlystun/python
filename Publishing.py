from Task4_functions import create_publication

#a = News('Emergency rescue operations completed at the site of the airstrike in Kharkiv','Kharkiv')
#a.publish('News_feed.txt')
#b = PrivateAd('Affordable Sliding Wardrobes for Sale!', '2024-11-12')
#b.publish('News_feed.txt')
#print(b.form_text_to_publish())
